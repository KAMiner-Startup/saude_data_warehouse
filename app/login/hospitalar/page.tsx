...
import { Building2, Lock, User, Eye, EyeOff, ShieldCheck, HeartPulse, Stethoscope, ArrowLeft } from "lucide-react"
...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      router.push("/portal-hospitalar/dashboard")
    }, 800)
  }
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(110deg, rgba(0,18,76,0.82) 0%, rgba(0,47,140,0.68) 35%, rgba(0,71,187,0.40) 60%, rgba(0,0,0,0.15) 100%)",
        }}
      />
        ...
        <div className="flex-1 text-white max-w-xl">
          ...
          <div className="flex items-center gap-3 mb-10">
            <div
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(0,71,187,0.50)",
              }}
            >
              <Building2 className="w-5 h-5 text-white" strokeWidth={1.25} />
            </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-white/75 text-sm leading-relaxed max-w-xs">
              Gerencie movimentações, cuidados e histórico clínico de cada paciente com segurança e agilidade.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-9">
            {[
              ...
              { Icon: HeartPulse, label: "Monitoramento contínuo de alertas" },
              { Icon: Stethoscope, label: "Integrado à Rede SUS Municipal" },
            ].map(({ Icon, label }) => (
        ...
        >
          ...
          <div className="mb-7">
            ...
            <p className="text-white/80 text-[13px]">
              Insira suas credenciais para acessar o portal hospitalar
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <User
                  className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-white/65"
                  strokeWidth={1.25}
                />
                <Input
                  id="username"
            ...
            <div className="text-right -mt-1">
              <button
                type="button"
                className="text-[12px] text-white/75 hover:text-white transition-colors cursor-pointer underline underline-offset-2"
              >
                Esqueci minha senha
              </button>
            </div>
