...
import { ClipboardList, Lock, User, Eye, EyeOff, ShieldCheck, CalendarCheck, Users, ArrowLeft } from "lucide-react"
...
export default function LoginRecepcaoPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      router.push("/portal-recepcao/dashboard")
    }, 800)
  }
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
      {/* Fundo */}
      <Image
        src={import.meta.env.BASE_URL + 'images/recepcao-bg.png'}
        alt="Recepção Saúde Búzios"
        fill
        className="object-cover object-center"
        priority
      />

      {/* Overlay gradiente âmbar */}
      <div
        className="absolute inset-0"
        style={{
          background:
            "linear-gradient(110deg, rgba(120,53,15,0.84) 0%, rgba(180,83,9,0.70) 35%, rgba(217,119,6,0.40) 60%, rgba(0,0,0,0.15) 100%)",
        }}
      />
        ...
        <div className="flex-1 text-white max-w-xl">
          ...
          <div className="flex items-center gap-3 mb-10">
            <div
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(180,83,9,0.50)",
              }}
            >
              <ClipboardList className="w-5 h-5 text-white" strokeWidth={1.25} />
            </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-white/75 text-sm leading-relaxed max-w-xs">
              Gerencie o fluxo de atendimento, registre chegadas e organize a fila de pacientes com agilidade.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-9">
            {[
              ...
              { Icon: CalendarCheck, label: "Controle de fluxo e agendamentos" },
              { Icon: Users, label: "Integrado à Rede SUS Municipal" },
            ].map(({ Icon, label }) => (
        ...
        >
          <div className="mb-7">
            ...
            <p className="text-white/80 text-[13px]">
              Insira suas credenciais para acessar o portal de recepção
            </p>
          </div>
