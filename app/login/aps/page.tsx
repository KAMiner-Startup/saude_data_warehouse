...
import { HeartPulse, Lock, User, Eye, EyeOff, ShieldCheck, Users, Stethoscope, ArrowLeft } from "lucide-react"
...
export default function LoginApsPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsLoading(false)
      router.push("/portal-atencao-basica/dashboard")
    }, 800)
  }

  // Cor predominante: verde APS
  const cor = { r: 22, g: 163, b: 74 } // green-600
  ...
  return (
    <main className="relative min-h-screen w-full overflow-hidden flex items-center justify-center">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(110deg, rgba(5,78,42,0.84) 0%, rgba(22,101,52,0.70) 35%, rgba(22,163,74,0.40) 60%, rgba(0,0,0,0.15) 100%)",
        }}
      />
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16">
        ...
        <div className="flex-1 text-white max-w-xl">
          ...
          <div className="flex items-center gap-3 mb-10">
            <div
              ...
              style={{
                ...
                boxShadow: "0 4px 20px rgba(22,163,74,0.50)",
              }}
            >
              <HeartPulse className="w-5 h-5 text-white" strokeWidth={1.25} />
            </div>
          ...
          <div className="mb-8">
            ...
            >
              Portal da Atenção Básica
            </h1>
            <p className="text-white/75 text-sm leading-relaxed max-w-xs">
              Acompanhe pacientes referenciados, registre comunicações e coordene o cuidado com a rede hospitalar.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-9">
            {[
              ...
              { Icon: Users, label: "Gestão de pacientes referenciados" },
        ...
        >
          <div className="mb-7">
            ...
            <p className="text-white/80 text-[13px]">
              Insira suas credenciais para acessar o portal da APS
            </p>
          </div>
